...
@Path("/order")
@org.eclipse.microprofile.openapi.annotations.tags.Tag(name = "order", description = "Order Workflow Sample + Entity Counting")
...
public class OrderResource {
    ...
    public Response createResource_order(@Context HttpHeaders httpHeaders, @Context UriInfo uriInfo, @QueryParam("businessKey") @DefaultValue("") String businessKey, @jakarta.validation.Valid() @jakarta.validation.constraints.NotNull() JsonNodeModelInput resource) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary = "order", description = "")
    public List<JsonNodeModelOutput> getResources_order() {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary = "order", description = "")
    public Map<String, Object> getResourceSchema_order() {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary = "order", description = "")
    public JsonNodeModelOutput getResource_order(@PathParam("id") String id) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary = "order", description = "")
    public JsonNodeModelOutput deleteResource_order(@PathParam("id") final String id) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary = "order", description = "")
    public JsonNodeModelOutput updateModel_order(@PathParam("id") String id, @jakarta.validation.Valid() @jakarta.validation.constraints.NotNull() JsonNodeModelInput resource) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary = "order", description = "")
    public JsonNodeModelOutput updateModelPartial_order(@PathParam("id") String id, @jakarta.validation.Valid() @jakarta.validation.constraints.NotNull() JsonNodeModelInput resource) {
